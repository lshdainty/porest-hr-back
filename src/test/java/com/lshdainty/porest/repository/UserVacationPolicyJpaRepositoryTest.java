...
import com.lshdainty.porest.vacation.repository.UserVacationPolicyJpaRepository;
...
@DataJpaTest
@Import({UserVacationPolicyJpaRepository.class, TestQuerydslConfig.class})
@Transactional
@DisplayName("JPA 유저휴가정책 레포지토리 테스트")
class UserVacationPolicyJpaRepositoryTest {
    @Autowired
    private UserVacationPolicyJpaRepository userVacationPolicyRepository;
