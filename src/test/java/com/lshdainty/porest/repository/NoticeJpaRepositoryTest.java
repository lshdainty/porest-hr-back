...
import com.lshdainty.porest.notice.repository.NoticeJpaRepository;
...
@DataJpaTest
@Import({NoticeJpaRepository.class, TestQuerydslConfig.class})
@Transactional
@DisplayName("JPA 공지사항 레포지토리 테스트")
