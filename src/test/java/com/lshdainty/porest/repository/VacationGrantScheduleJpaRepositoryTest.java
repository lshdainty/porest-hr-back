...
import com.lshdainty.porest.vacation.repository.VacationGrantScheduleJpaRepository;
...
@DataJpaTest
@Import({VacationGrantScheduleJpaRepository.class, TestQuerydslConfig.class})
@Transactional
@DisplayName("JPQL 휴가 부여 스케줄 레포지토리 테스트")
class VacationGrantScheduleJpaRepositoryTest {
    @Autowired
    private VacationGrantScheduleJpaRepository vacationGrantScheduleRepository;
