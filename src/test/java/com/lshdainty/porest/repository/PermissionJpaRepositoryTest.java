...
import com.lshdainty.porest.permission.repository.PermissionJpaRepository;
...
@DataJpaTest
@Import({PermissionJpaRepository.class, TestQuerydslConfig.class})
@Transactional
@DisplayName("JPA 권한 레포지토리 테스트")
