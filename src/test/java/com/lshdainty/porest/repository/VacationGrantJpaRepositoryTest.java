...
import com.lshdainty.porest.vacation.repository.VacationGrantJpaRepository;
...
@DataJpaTest
@Import({VacationGrantJpaRepository.class, TestQuerydslConfig.class})
@Transactional
@DisplayName("JPA 휴가부여 레포지토리 테스트")
class VacationGrantJpaRepositoryTest {
    @Autowired
    private VacationGrantJpaRepository vacationGrantRepository;
