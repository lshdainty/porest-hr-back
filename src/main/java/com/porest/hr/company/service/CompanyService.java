...
public interface CompanyService {
     ...
     * @param data 회사 등록 정보
     * @return 생성된 회사 ID
     * @throws com.porest.core.exception.DuplicateException 이미 존재하는 회사 ID인 경우
     */
     ...
     *
     * @param data 회사 수정 정보
     * @throws com.porest.core.exception.EntityNotFoundException 회사가 존재하지 않는 경우
     */
     ...
     * @param id 회사 ID
     * @throws com.porest.core.exception.EntityNotFoundException 회사가 존재하지 않는 경우
     * @throws com.porest.core.exception.BusinessRuleViolationException 부서가 존재하는 경우
     */
     ...
     * @return 회사 엔티티
     * @throws com.porest.core.exception.EntityNotFoundException 회사가 존재하지 않거나 삭제된 경우
     */
